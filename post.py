...
mydata = {
    ...
    'explored': [
        [
            {'x': 150.0, 'y': 30.0, 'z': 0.0},
            {'x': 150.0, 'y': 90.0, 'z': 0.0},
            {'x': 80.0, 'y': 160.0, 'z': 0.0},
            {'x': 60.0, 'y': 120.0, 'z': 0.0},
        ],
        [
            {'x': 250.0, 'y': 80.0, 'z': 0.0},
            {'x': 290.0, 'y': 160.0, 'z': 0.0},
            {'x': 260.0, 'y': 120.0, 'z': 0.0},
            {'x': 210.0, 'y': 90.0, 'z': 0.0},
        ],
    ],
